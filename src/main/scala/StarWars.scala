object StarWars {
  ...
  /**
   * @param name The name of the person to retrieve the fastest spaceship for
   * @return This method should retrieve the fastest spaceship for the given Person from the Star Wars API
   *
